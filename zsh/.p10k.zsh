# Generated by Powerlevel10k configuration wizard on 2026-05-11 at 10:29 CEST.
...
() {
  ...
  function prompt_repo_version() {
    local tag
    tag=$(git describe --tags --abbrev=0 2> /dev/null) || return
